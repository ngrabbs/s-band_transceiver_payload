...
void config_load_defaults(void) {
    ...
    sys_config.radio_tx_interval_ms = 5000;

    pin_config.spi_bus = spi0;
    pin_config.spi_sck = 2;
    pin_config.spi_mosi = 3;
    pin_config.spi_miso = 4;

    pin_config.cs_lora = 5;
    pin_config.cs_can = 6;

    pin_config.lora_reset = 22;
    pin_config.lora_busy  = 26;
    pin_config.lora_dio1  = 27;
